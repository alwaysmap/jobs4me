...
**Target send window:** 2026-04-19 to 2026-04-25  (first follow-up band; adjust if you make warm contact sooner)
...
Lead with **variant 2 (warm intro ask)** if you can find a mutual connection to {Name} — even a weak tie is worth more than a cold note. If no warm path surfaces within a few days, switch to **variant 1 (cold hiring manager)** aimed at the same person. Use **variant 3 (recruiter ping)** as the fallback only if you can't identify a hiring manager at all; it's the lowest-leverage of the three and won't move the needle on its own.

Target send window is 2026-04-19 to 2026-04-25 based on your cadence — that's the first follow-up band. If you land a warm intro earlier, send it as soon as you have it; warm-path activation doesn't wait for the follow-up clock.
